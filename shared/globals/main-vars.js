/* mainvar */
/* Load Timestamp 13:57:33.254 */
export const TOP = window.top;
export const MAIN = window;
export const SESSION = {}; //wordt pas gezet als er een session is;
...
export const MAINDOC = document;
export let PAGEDOC = null;
export let SESSIONDOC = null;
...
// Global state
export const GLOBAL = MAIN.GLOBAL;
...
// Oculus globals
export const OCULUS = MAIN.OCULUS;
...
// Update function for PAGEDOC and SESSIONDOC
export function setPageDoc(doc) {
    PAGEDOC = doc;
}

export function setSessionDoc(doc) {
    SESSIONDOC = doc;
}