/* NAV.SubProcedure - SubProcedure Navigation Component */
/* Extracted from session/functions.js for modularization */

/**
 * NAV.SubProcedure - Manages sub-procedure navigation and execution
 * Handles sub-procedures within procedures and their associated macros
 */
...
// Export NAV.SubProcedure globally for backward compatibility
if (typeof window !== 'undefined' && window.NAV) {
    window.NAV.SubProcedure = NAV.SubProcedure;
}
