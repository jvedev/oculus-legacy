/* NAV.Macro - Macro Navigation Component */
/* Extracted from session/functions.js for modularization */

/**
 * NAV.Macro - Manages macro execution and navigation
 * Handles macro definitions, targets, and workflow execution
 */
...
// Export NAV.Macro globally for backward compatibility
if (typeof window !== 'undefined' && window.NAV) {
    window.NAV.Macro = NAV.Macro;
}
